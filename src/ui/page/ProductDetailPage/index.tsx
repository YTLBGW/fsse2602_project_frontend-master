...
export default function ProductDetailPage() {
  ...
  const renderAddToCartBtn = () => {
    if(isSuccessAddToCart){
      return <Button className="ms-2" variant="success" style={{height: 40, width: 100, padding: 0}}>Success Added</Button>
    }else if(isAddingToCart){
      return <Button className="ms-2" style={{height: 40, width: 100, padding: 0}} onClick={handleAddToCart} disabled>Add to Cart</Button>
    }else{
      return <Button className="ms-2" style={{height: 40, width: 100, padding: 0}} onClick={handleAddToCart}>Add to Cart</Button>
    }
  }
